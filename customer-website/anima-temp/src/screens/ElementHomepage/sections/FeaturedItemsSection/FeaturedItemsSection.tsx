...
<div className={`relative self-stretch w-full h-64 rounded-lg ${card.badges.length > 0 ? 'flex items-start gap-2 p-2 overflow-hidden' : ''} [background:url(${card.image})_50%_50%_/_cover]`}>
