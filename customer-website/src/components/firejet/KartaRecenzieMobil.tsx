import Icon32Px3 from "./assets/Icon32Px3";
...
export default function KartaRecenzieMobil({
  ...
  return (
    <div
      className={`flex flex-col items-start justify-end gap-2 rounded-3xl px-6 pb-6 pt-52 drop-shadow-lg ${className}`}
    >
      <div
      ...
      <Icon32Px3 className="absolute right-4 top-4 z-[1] h-8 w-8" />
