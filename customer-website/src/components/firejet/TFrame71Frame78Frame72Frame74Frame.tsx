...
export default function TFrame71Frame78Frame72Frame74Frame({
  ...
  return (
    <div className={`flex flex-col items-center gap-4 ${className}`}>
      <div className="flex flex-wrap items-center justify-between gap-x-16 gap-y-[5px] self-stretch rounded-lg bg-zinc-900 py-4 pl-6 pr-4 min-[1818px]:flex-nowrap" >
      ...
      <div
        className={`flex flex-wrap items-center gap-y-[5px] rounded-lg bg-zinc-900 py-4 pl-6 pr-4 min-[1818px]:flex-nowrap ${container2}`}
      >
      ...
      <div
        className={`flex w-[567px] flex-wrap items-center justify-center gap-y-[5px] rounded-lg bg-zinc-900 py-4 pl-6 pr-4 min-[1818px]:flex-nowrap ${container4}`}
      >
      ...
      <div
        className={`flex flex-wrap items-center gap-y-[5px] rounded-lg bg-zinc-900 py-4 pl-6 pr-4 min-[1818px]:flex-nowrap ${container6}`}
      >
      ...
      <div
        className={`flex flex-wrap items-center gap-y-[5px] rounded-lg bg-zinc-900 py-4 pl-6 pr-4 min-[1818px]:flex-nowrap ${container8}`}
      >
