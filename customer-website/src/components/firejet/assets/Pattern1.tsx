export default function Pattern1({ className = "" }: Pattern1Props) {
  return (
    <div className={`${className}`}>
      ...
      <g clipPath="url(#clip0_16881_11070)">
      <g clipPath="url(#clip1_16881_11070)">
      ...
      <defs>
      <clipPath id="clip0_16881_11070">
      <rect width="304" height="304" rx="24" fill="white"/>
      </clipPath>
      <clipPath id="clip1_16881_11070">
