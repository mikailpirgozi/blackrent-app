...
export const TypInfoBoxSubsection: React.FC<TypInfoBoxSubsectionProps> = ({
  ...
  return (
    <div className="bg-[#1E1E23] flex flex-col w-[328px] sm:w-[400px] md:w-[680px] lg:w-[448px] xl:w-[448px] 2xl:w-[536px] items-center gap-4 sm:gap-6 relative rounded-3xl overflow-hidden">
