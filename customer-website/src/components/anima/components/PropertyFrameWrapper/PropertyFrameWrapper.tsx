...
import { Icon24PxFilled98 } from "../../icons/Icon24PxFilled98";
...
export const PropertyFrameWrapper = ({
  ...
  return (
    <div
      className={`flex flex-col w-[1728px] items-center gap-2 pt-[200px] pb-60 px-2 relative rounded-[40px_40px_0px_0px] overflow-hidden ${className}`}
    >
...
PropertyFrameWrapper.propTypes = {
  property1: PropTypes.oneOf(["frame-375"]),
};
