...
export const KartaVozidla = ({
  ...
  return (
    <div
      className={`w-[328px] flex flex-col items-start gap-[23px] p-4 h-[392px] overflow-hidden rounded-3xl justify-around relative transition-all duration-200 hover:scale-105 ${type === "hover" ? "bg-colors-black-600" : "bg-colors-black-400 hover:bg-colors-black-600"} ${className}`}
    >
      <div
