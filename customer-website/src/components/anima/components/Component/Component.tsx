...
export const Component = ({
  property1,
  className,
  blackrentLogo = "https://c.animaapp.com/h23eak6p/img/blackrent-logo-1.svg",
}: Props): JSX.Element => {
  return (
    <div
        ...
        <div className="flex flex-col items-start gap-12 relative self-stretch w-full flex-[0_0_auto]">
          ...
          <div className="flex flex-col w-40 items-start gap-6 relative flex-[0_0_auto]">
            ...
            <div className="inline-flex items-start gap-4 relative flex-[0_0_auto]">
              <TypMenuWrapper
                ...
                typ="facebook"
                typFacebook="https://c.animaapp.com/h23eak6p/img/icon-24-px-63.svg"
              />
              <TypMenuWrapper
                className="!relative !left-[unset] !top-[unset]"
                typ="instagram"
                typInstagram="https://c.animaapp.com/h23eak6p/img/icon-24-px-64.svg"
              />
              <TypMenuWrapper
                className="!relative !left-[unset] !top-[unset]"
                typ="tik-tok"
                typTiktok="https://c.animaapp.com/h23eak6p/img/icon-24-px-65.svg"
              />
            </div>
          </div>
          ...
          <div className="absolute w-[172px] h-[386px] top-[201px] left-[156px]">
            <img
              ...
              alt="Vector"
              src="https://c.animaapp.com/h23eak6p/img/vector-21.svg"
            />
          </div>
        </div>
      </div>
