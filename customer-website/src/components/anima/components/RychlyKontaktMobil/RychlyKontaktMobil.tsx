...
export const RychlyKontaktMobil = ({
  ...
  return (
    ...
    >
      <div className="absolute w-[104px] h-[104px] -top-12 left-28 rounded-[99px] border border-solid border-colors-white-800 bg-[url(https://c.animaapp.com/h23eak6p/img/fotka-oper-tora-11@2x.png)] bg-cover bg-[50%_50%]" />
      ...
      <div className="absolute w-16 h-[152px] top-[152px] left-0 rounded-2xl overflow-hidden">
        <div className="relative h-[185px] top-2">
          <img
            ...
            alt="Vector"
            src="https://c.animaapp.com/h23eak6p/img/vector-22.svg"
          />
        </div>
      </div>
        ...
        <div className="inline-flex flex-col items-center gap-6 relative flex-[0_0_auto]">
          <div className="flex w-[165px] items-center gap-2 relative flex-[0_0_auto]">
            <TypMenuWrapper
              ...
              typ="mobil"
              typMobil="https://c.animaapp.com/h23eak6p/img/icon-24-px-66.svg"
            />
          ...
          <img
            ...
            alt="Line"
            src="https://c.animaapp.com/h23eak6p/img/line-21-2.svg"
          />
          ...
          <div className="flex w-[165px] items-center justify-center gap-2 relative flex-[0_0_auto]">
            <TypMenuWrapper
              className="!relative !left-[unset] !top-[unset]"
              typ="message"
              typMessage="https://c.animaapp.com/h23eak6p/img/icon-24-px-67.svg"
            />
            <div className="inline-flex flex-col items-start gap-4 relative flex-[0_0_auto]">
