...
export const PropertyXWrapper = ({
  property1,
  className,
  frame = "https://c.animaapp.com/h23eak6p/img/frame-2608626-1.svg",
  href,
}: Props): JSX.Element => {
  return (
    <div
    ...
    >
      <img
        className="absolute w-[158px] h-[336px] top-0 left-0"
        alt="Frame"
        src={frame}
      />

      <div className="absolute w-[104px] h-[104px] -top-12 left-72 rounded-[99px] border border-solid border-colors-white-800 bg-[url(https://c.animaapp.com/h23eak6p/img/fotka-oper-tora-11@2x.png)] bg-cover bg-[50%_50%]" />
