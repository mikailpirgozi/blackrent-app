              ...
              <div className="flex flex-col items-center gap-2 pt-[133px]">
                ...
                <div className="flex flex-col items-center gap-2">
                  <div className="flex flex-row justify-center items-center gap-4 px-6 py-4 h-10">
                    <Link href="/vozidla" className="font-medium text-[#A0A0A5] text-base text-center [font-family:'Poppins',Helvetica] leading-6 whitespace-nowrap hover:text-white transition-colors">
                      Ponuka vozidiel
                    </Link>
                  </div>
                  <div className="flex flex-row justify-center items-center gap-4 px-6 py-4 h-10">
                    <Link href="#" className="font-medium text-[#A0A0A5] text-base text-center [font-family:'Poppins',Helvetica] leading-6 whitespace-nowrap hover:text-white transition-colors">
                      Store
                    </Link>
                  </div>
                  <div className="flex flex-row justify-center items-center gap-4 px-6 py-4 h-10">
                  ...
                  <div className="flex flex-row justify-center items-center gap-2 px-4 py-3 h-10 rounded-lg">
                    ...
                    <div className="font-medium text-[#A0A0A5] text-sm text-right [font-family:'Poppins',Helvetica] leading-6 whitespace-nowrap">
                      SK
                    </div>
                  </div>
                  ...
                  <button className="flex flex-row justify-center items-center gap-1.5 pl-5 pr-6 py-3 h-10 bg-[#141900] rounded-[99px] hover:bg-[#1a1f00]">
                    ...
                    />
                    <div className="font-medium text-[#d7ff14] text-sm [font-family:'Poppins',Helvetica] leading-6 whitespace-nowrap">
                      Prihlásiť sa
                    </div>
                  </button>
                </div>
          ...
          <nav className="inline-flex items-center justify-center relative flex-[0_0_auto]">
            <div className="inline-flex items-center justify-center gap-2 relative self-stretch flex-[0_0_auto]">
              {navigationItems.map((item, index) => (
                ...
                >
                  <div className="relative w-fit font-medium text-[#bebec3] text-sm leading-6 [font-family:'Poppins',Helvetica] tracking-[0] whitespace-nowrap hover:text-white transition-colors">
                    {item.label}
                  </div>
                </Link>
              ))}
