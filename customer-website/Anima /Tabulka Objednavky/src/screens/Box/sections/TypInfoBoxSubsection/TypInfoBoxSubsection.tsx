...
export const TypInfoBoxSubsection = (): JSX.Element => {
  ...
  return (
    <div className="bg-colors-black-600 flex flex-col w-[536px] items-center gap-6 relative rounded-3xl overflow-hidden">
        ...
        <div className="flex flex-col items-start gap-6 relative self-stretch w-full flex-[0_0_auto]">
                ...
                >
                  <div className="flex items-center gap-1 relative flex-1 grow">
                    <input
                      ...
                      className="relative w-fit mt-[-1.00px] [font-family:'Poppins',Helvetica] font-medium text-colors-ligh-gray-800 text-sm tracking-[0] leading-6 whitespace-nowrap bg-transparent border-none outline-none placeholder:text-colors-ligh-gray-800"
          ...
          <div className="flex flex-col items-center gap-4 relative self-stretch w-full flex-[0_0_auto]">
            ...
            <button
              ...
              className="flex flex-col h-10 items-start justify-center gap-4 p-4 relative self-stretch w-full bg-colors-black-600 rounded-lg cursor-pointer hover:bg-colors-black-700 transition-colors"
              aria-expanded={promoCodeExpanded}
            ...
            {showTooltip && (
              <div className="absolute w-[190px] h-24 top-28 left-32 z-10">
                <div className="relative w-[188px] h-[94px] bg-[url(/img/rectangle-962.svg)] bg-[100%_100%]">
                  <p className="absolute w-[168px] h-[55px] top-[11px] left-2.5 text-colors-white-800 text-[10px] leading-4 [font-family:'Poppins',Helvetica] font-normal tracking-[0]">
                  ...
                  >
                    <label className="flex items-center gap-1.5 relative flex-1 grow cursor-pointer">
                      ...
                      <p
                        ...
                        className="relative flex-1 [font-family:'Poppins',Helvetica] font-normal text-colors-white-800 text-sm tracking-[0] leading-6"
                      >
