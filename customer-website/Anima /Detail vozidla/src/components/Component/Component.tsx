...
export const Component = ({
  ...
  icon = <TypFacebook className="!relative !w-6 !h-6" color="#BEBEC3" />,
  override = <TypInstagram className="!relative !w-6 !h-6" color="#BEBEC3" />,
  icon1 = <Icon24Px51 className="!relative !w-6 !h-6" color="#BEBEC3" />,
