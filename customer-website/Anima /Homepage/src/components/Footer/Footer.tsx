...
export const Footer = ({
  ...
  icon = <TypFacebook className="!relative !w-6 !h-6" color="#A0A0A5" />,
  override = <TypInstagram className="!relative !w-6 !h-6" color="#A0A0A5" />,
  icon1 = <Icon24Px63 className="!relative !w-6 !h-6" color="#A0A0A5" />,
}: Props): JSX.Element => {
  return (
    <div
    ...
    >
      <div className="relative w-[1280px] h-[1068px] left-40">
        ...
        <div className="flex flex-col w-[1120px] items-start gap-20 absolute top-[336px] left-0">
          <div
            className={`relative w-[214.4px] h-8 bg-[url(/img/vector-29.svg)] bg-[100%_100%] ${blackrentLogoClassName}`}
          />
