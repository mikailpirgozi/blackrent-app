...
exports.calculateRentalDaysLegacy = calculateRentalDaysLegacy;
exports.compareRentalDaysImplementations = compareRentalDaysImplementations;
/**
...
function calculateRentalDays(startDate, endDate) {
    ...
    if (!(startDate instanceof Date) || !(endDate instanceof Date)) {
        throw new Error('calculateRentalDays: startDate a endDate musia byť Date objekty');
    }
 ...
 */
function calculateRentalDaysLegacy(startDate, endDate, version) {
    switch (version) {
        case 'v1': {
 ...
 */
function compareRentalDaysImplementations(startDate, endDate) {
    ...
    return {
        ...
        isConsistent: v1Result === v2Result && v2Result === v3Result && v3Result === newResult,
    };
}
//# sourceMappingURL=rentalDaysCalculator.js.map