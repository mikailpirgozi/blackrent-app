...
class ImageProcessor {
     ...
     */
    async generateDerivatives(inputBuffer) {
        // Validácia vstupu
     ...
     */
    async generateThumbnail(inputBuffer) {
     ...
     */
    async generateGalleryVersion(inputBuffer) {
        return (0, sharp_1.default)(inputBuffer)
     ...
     */
    async generatePdfVersion(inputBuffer) {
        return (0, sharp_1.default)(inputBuffer)
