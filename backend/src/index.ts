...
import paymentOrdersRoutes from './routes/payment-orders'; // 💳 PAYMENT ORDERS: QR platobné príkazy
...
app.use('/api/payment-orders', paymentOrdersRoutes); // 💳 PAYMENT ORDERS: QR platobné príkazy
