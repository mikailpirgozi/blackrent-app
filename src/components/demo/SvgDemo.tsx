...
export const SvgDemo: React.FC = () => {
  return (
    <div className="p-8 bg-gray-50 rounded-lg shadow-md max-w-md mx-auto my-8">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">SVG & Assets Demo</h2>
      
      {/* SVG ako React komponenty */}
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-gray-700 mb-3">SVG ako React komponenty:</h3>
        ...
        <div className="flex items-center space-x-4 mt-2">
          ...
          <span className="text-sm text-gray-600">ReactLogo (existujúci SVG)</span>
        </div>
      </div>

      {/* PNG import z src/assets */}
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-gray-700 mb-3">PNG z src/assets:</h3>
        <div className="flex items-center space-x-4">
          <img src={samplePng} alt="Sample PNG" className="w-8 h-8 bg-red-200" />
          <span className="text-sm text-gray-600">sample.png (importovaný)</span>
        </div>
      </div>

      {/* Public assets */}
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-gray-700 mb-3">Public assets:</h3>
        <div className="flex items-center space-x-4">
