...
// TODO: Will be migrated to shadcn/ui components
// import { Dialog, Button, Input, Select } from '@/components/ui/...';

// Keep MUI temporarily during migration
import {
  Accordion,
  AccordionDetails,
  AccordionSummary,
          ...
          <Accordion defaultExpanded>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography
                ...
                sx={{ display: 'flex', alignItems: 'center', gap: 1 }}
              >
                <ContractIcon className="text-blue-600" />
          ...
          <Accordion defaultExpanded sx={{ mt: 1 }}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography
                ...
                sx={{ display: 'flex', alignItems: 'center', gap: 1 }}
              >
                <InvoiceIcon className="text-green-600" />
