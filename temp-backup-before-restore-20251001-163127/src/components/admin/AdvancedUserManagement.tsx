  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <Card sx={{ mb: 2 }}>
        ...
        >
          <Tab icon={<UnifiedIcon name="building" />} label="Organizácia" />
          <Tab icon={<GroupIcon />} label="Používatelia" />
          <Tab icon={<UnifiedIcon name="security" />} label="Role" />
          <Tab icon={<UnifiedIcon name="building" />} label="Oddelenia" />
      ...
      <TabPanel value={currentTab} index={1}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
          ...
          <Button
            variant="contained"
            startIcon={<UnifiedIcon name="personAdd" />}
            onClick={() => {
