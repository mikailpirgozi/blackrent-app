            ...
            {showCount < data.length && (
              <Box sx={{ mt: 3, textAlign: 'center' }}>
                <Button
                  variant="outlined"
                  onClick={onLoadMore}
                  startIcon={<UnifiedIcon name="keyboardArrowDown" />}
                  sx={{
                    borderColor: '#667eea',
                    color: '#667eea',
                    '&:hover': {
        ...
        >
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              <UnifiedIcon name="dashboard" sx={{ fontSize: 32 }} />
              <Box>
      ...
      <Grid container spacing={3} sx={{ mb: 3 }}>
        ...
        <Grid item xs={12} sm={6} md={4}>
          <StatCard
            ...
            subtitle={formatPeriod()}
            icon={<UnifiedIcon name="accountBalance" />}
