...
export const SuccessToast: React.FC<SuccessToastProps> = ({
  ...
  const getIcon = () => {
    ...
    switch (icon) {
      case 'speed':
        return <UnifiedIcon name="speed" {...iconProps} />;
      case 'cloud':
        return <CloudDoneIcon {...iconProps} />;
      case 'refresh':
        return <UnifiedIcon name="refresh" {...iconProps} />;
      default:
        return <UnifiedIcon name="success" {...iconProps} />;
    }
  };
      ...
      <Alert
        ...
        action={
          <IconButton
            ...
            sx={{ color: 'inherit' }}
          >
            <UnifiedIcon name="close" fontSize="small" />
          </IconButton>
        }
      >
        <Box>
              ...
              {showStats.duration !== undefined && (
                <Fade in timeout={1000}>
                  <Chip
                    ...
                    variant="outlined"
                    icon={<UnifiedIcon name="speed" fontSize="small" />}
                    sx={{
                      bgcolor: 'rgba(255,255,255,0.1)',
                      color: 'inherit',
                      borderColor: 'rgba(255,255,255,0.3)',
