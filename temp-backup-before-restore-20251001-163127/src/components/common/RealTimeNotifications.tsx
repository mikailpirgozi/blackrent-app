...
const RealTimeNotifications: React.FC = () => {
  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      case 'rental_created':
        return <UnifiedIcon name="add" color="success" />;
      case 'rental_updated':
        return <UnifiedIcon name="edit" color="info" />;
      case 'rental_deleted':
        return <UnifiedIcon name="delete" color="error" />;
      case 'vehicle_updated':
        return <CarIcon color="primary" />;
      case 'customer_created':
        return <UnifiedIcon name="user" color="success" />;
      case 'system':
        return <UnifiedIcon name="info" color="warning" />;
      default:
        ...
        <Box sx={{ p: 2, borderBottom: 1, borderColor: 'divider' }}>
          ...
          >
            ...
            {notifications.length > 0 && (
              <Button
                size="small"
                startIcon={<UnifiedIcon name="clear" />}
