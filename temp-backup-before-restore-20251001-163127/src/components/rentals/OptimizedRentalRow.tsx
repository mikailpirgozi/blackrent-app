          ...
          {hasHandoverProtocol && (
            <Tooltip title="Odovzdávací protokol">
              <IconButton size="small" onClick={handleViewPDF}>
                <UnifiedIcon name="pdf" fontSize="small" color="success" />
              </IconButton>
            </Tooltip>
          )}
          {hasReturnProtocol && (
            <Tooltip title="Preberací protokol">
              <IconButton size="small" onClick={handleViewPDF}>
                <UnifiedIcon name="pdf" fontSize="small" color="info" />
              </IconButton>
            </Tooltip>
          )}
        ...
        <Stack direction="row" spacing={0.5}>
          <Tooltip title="Zobraziť">
            <IconButton size="small" onClick={handleView}>
              <UnifiedIcon name="eye" fontSize="small" />
            </IconButton>
          </Tooltip>
          ...
          <Tooltip title="Odovzdať">
            ...
            >
              <UnifiedIcon name="handover" fontSize="small" />
            </IconButton>
          </Tooltip>
          ...
          <Tooltip title="Prevziať">
            ...
            >
              <UnifiedIcon name="return" fontSize="small" />
            </IconButton>
          </Tooltip>

          <Tooltip title="Galéria">
            <IconButton size="small" onClick={handleViewGallery}>
              <UnifiedIcon name="gallery" fontSize="small" />
            </IconButton>
          </Tooltip>
