...
const RentalCardView: React.FC<RentalCardViewProps> = ({
  ...
  const getStatusIcon = (status: string | undefined) => {
    switch (status?.toLowerCase()) {
      case 'aktívny':
      case 'active':
        return <UnifiedIcon name="success" fontSize="small" />;
      case 'dokončený':
      case 'completed':
        return <UnifiedIcon name="success" fontSize="small" />;
      case 'zrušený':
      ...
      case 'po termíne':
      case 'overdue':
        return <UnifiedIcon name="pending" fontSize="small" />;
      default:
        return <UnifiedIcon name="pending" fontSize="small" />;
    }
  };
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', gap: 0.5 }}>
            {hasHandover && (
              <Chip
                icon={<UnifiedIcon name="handover" />}
                label=""
                color="success"
                size="small"
                sx={{
        ...
        <CardContent sx={{ p: 2, pt: 4 }}>
          ...
          <Box sx={{ mb: 1.5 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <UnifiedIcon name="user" color="action" fontSize="small" />
          ...
          <Box sx={{ display: 'flex', gap: 0.5, mb: 1, flexWrap: 'wrap' }}>
            ...
            {hasHandover && (
              <Button
                size="small"
                variant="outlined"
                startIcon={<UnifiedIcon name="pdf" />}
                onClick={e => {
                  e.stopPropagation();
      ...
      >
        ...
        <CardContent sx={{ p: 3, pt: 4 }}>
          ...
          <Box sx={{ mb: 2 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <UnifiedIcon name="building" color="action" fontSize="small" />
          ...
          <Box sx={{ display: 'flex', gap: 1, mb: 2 }}>
            {!hasHandover && (
              <Button
                size="small"
                variant="outlined"
                startIcon={<UnifiedIcon name="handover" />}
                onClick={e => {
                  e.stopPropagation();
            ...
            {hasHandover && !hasReturn && (
              <Button
                size="small"
                variant="outlined"
                startIcon={<UnifiedIcon name="return" />}
                onClick={e => {
                  e.stopPropagation();
            ...
            <Box sx={{ display: 'flex', gap: 1, mb: 2 }}>
              ...
              {((hasHandover?.vehicleImages?.length ?? 0) > 0 ||
                ...
                <Button
                  size="small"
                  variant="outlined"
                  startIcon={<UnifiedIcon name="gallery" />}
                  onClick={e => {
                    e.stopPropagation();
