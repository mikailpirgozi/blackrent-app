  ...
  switch (status) {
    ...
    case 'investigating':
      return {
        ...
        color: '#1976d2',
        bgColor: '#e3f2fd',
        icon: <UnifiedIcon name="search" sx={{ fontSize: 14 }} />,
      };
    case 'approved':
      return {
        label: 'Schválené',
        color: '#388e3c',
        bgColor: '#e8f5e8',
        icon: <UnifiedIcon name="success" sx={{ fontSize: 14 }} />,
      };
    case 'rejected':
      return {
        label: 'Zamietnuté',
        color: '#d32f2f',
        bgColor: '#ffebee',
        icon: <UnifiedIcon name="error" sx={{ fontSize: 14 }} />,
      };
    case 'closed':
      return {
        label: 'Uzavreté',
    ...
    default:
      return {
        ...
        color: '#616161',
        bgColor: '#f5f5f5',
        icon: <UnifiedIcon name="warning" sx={{ fontSize: 14 }} />,
      };
  }
};
        ...
        <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
          ...
          >
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <UnifiedIcon name="search" sx={{ color: 'text.secondary', mr: 1 }} />
                ),
              }}
              sx={{
                flex: 1,
            ...
            >
              <Button
                ...
                startIcon={
                  <UnifiedIcon name="filter" sx={{ fontSize: { xs: 18, sm: 20 } }} />
                }
              ...
              {hasActiveFilters && (
                <Button
                  variant="outlined"
                  startIcon={
                    <UnifiedIcon name="close" sx={{ fontSize: { xs: 18, sm: 20 } }} />
                  }
                    ...
                    return (
                      <TableRow key={claim.id} hover>
                        <TableCell>
                          ...
                          >
                            <UnifiedIcon name="event" sx={{ fontSize: 18, color: 'text.secondary' }} />
                            {format(
                          ...
                          <Box sx={{ display: 'flex', gap: 1 }}>
                            <Tooltip title="Upraviť">
                              <IconButton
                                ...
                                sx={{ color: '#1976d2' }}
                              >
                                <UnifiedIcon name="edit" sx={{ fontSize: 18 }} />
                              </IconButton>
                            </Tooltip>
                            <Tooltip title="Vymazať">
                              <IconButton
                                ...
                                sx={{ color: '#d32f2f' }}
                              >
                                <UnifiedIcon name="delete" sx={{ fontSize: 18 }} />
                              </IconButton>
                            </Tooltip>
                          </Box>
                        </TableCell>
                        ...
                        >
                          ...
                          <Box sx={{ display: 'flex', gap: 0.5 }}>
                            <IconButton
                              ...
                              sx={{ color: '#1976d2' }}
                            >
                              <UnifiedIcon name="edit" sx={{ fontSize: 16 }} />
                            </IconButton>
                            <IconButton
                              size="small"
                              onClick={() => handleDelete(claim.id)}
                              sx={{ color: '#d32f2f' }}
                            >
                              <UnifiedIcon name="delete" sx={{ fontSize: 16 }} />
                            </IconButton>
                          </Box>
                        </Box>
