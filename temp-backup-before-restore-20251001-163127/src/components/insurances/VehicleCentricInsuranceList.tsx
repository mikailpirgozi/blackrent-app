...
const getDocumentTypeInfo = (type: string) => {
  switch (type) {
    case 'insurance_pzp':
      return {
        label: 'Poistka - PZP',
        icon: <UnifiedIcon name="security" sx={{ fontSize: 20 }} />,
        color: '#1976d2',
      };
    ...
    case 'stk':
      return {
        label: 'STK',
        icon: <UnifiedIcon name="build" sx={{ fontSize: 20 }} />,
        color: '#388e3c',
      };
    case 'ek':
      return {
        label: 'EK',
        icon: <UnifiedIcon name="assignment" sx={{ fontSize: 20 }} />,
        color: '#f57c00',
      };
    case 'vignette':
      return {
    ...
    default:
      return {
        label: type,
        icon: <UnifiedIcon name="report" sx={{ fontSize: 20 }} />,
        color: '#666',
      };
  }
};
  ...
  return (
    ...
    >
              ...
              >
                ...
                >
                  ...
                  <Select
                    ...
                    startAdornment={
                      !isMobile ? (
                        <UnifiedIcon name="sort" sx={{ mr: 1, color: 'text.secondary' }} />
                      ) : undefined
                    }
                  >
                ...
                <Button
                  ...
                  startIcon={<UnifiedIcon name="filter" />}
                    ...
                    <FormControl fullWidth size={isMobile ? 'small' : 'medium'}>
                      ...
                      >
                        ...
                        <MenuItem value="insurance_pzp">
                          ...
                          >
                            <UnifiedIcon name="security" sx={{ fontSize: 16 }} />
                            Poistka - PZP
                          </Box>
                        </MenuItem>
                        ...
                        <MenuItem value="stk">
                          ...
                          >
                            <UnifiedIcon name="build" sx={{ fontSize: 16 }} />
                            STK
                          </Box>
                        </MenuItem>
                        <MenuItem value="ek">
                          ...
                          >
                            <UnifiedIcon name="assignment" sx={{ fontSize: 16 }} />
                            EK
                          </Box>
                        </MenuItem>
                    ...
                    <FormControl fullWidth size={isMobile ? 'small' : 'medium'}>
                      ...
                      >
                        ...
                        <MenuItem value="valid">
                          ...
                          >
                            <UnifiedIcon name="success" sx={{ fontSize: 16, color: 'success.main' }} />
                            Platné
                          </Box>
                        </MenuItem>
                        ...
                        <MenuItem value="expired">
                          ...
                          >
                            <UnifiedIcon name="error" sx={{ fontSize: 16, color: 'error.main' }} />
                            Vypršané
                          </Box>
                        </MenuItem>
                      </Select>
      ...
      {activeTab === 0 && overallStats.expiredDocs > 0 && (
        <Alert severity="error" sx={{ mb: 3 }} icon={<UnifiedIcon name="warning" />}>
      ...
      {activeTab === 0 && sortedVehicles.length === 0 && !loading && (
        <Card sx={{ textAlign: 'center', py: 6, mt: 3 }}>
          <CardContent>
            <UnifiedIcon name="security" sx={{ fontSize: 64, color: 'text.secondary', mb: 2 }} />
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {stats.expired > 0 && (
                ...
                >
                  <Chip
                    ...
                    color="error"
                    size="small"
                    icon={<UnifiedIcon name="error" sx={{ fontSize: { xs: 14, sm: 16 } }} />}
                    sx={{
              ...
              {!stats.hasProblems && (
                <Chip
                  ...
                  size="small"
                  icon={
                    <UnifiedIcon name="success" sx={{ fontSize: { xs: 14, sm: 16 } }} />
                  }
                  sx={{
                    fontSize: { xs: '0.75rem', sm: '0.8125rem' },
                    height: { xs: 24, sm: 32 },
            ...
            >
              {expanded ? (
                <UnifiedIcon name="chevronUp" sx={{ fontSize: { xs: 20, sm: 24 } }} />
              ) : (
                <UnifiedIcon name="chevronDown" sx={{ fontSize: { xs: 20, sm: 24 } }} />
              )}
            </IconButton>
          </Box>
        </Box>
        ...
        {isMobile ? (
          ...
          >
            ...
            <Button
              ...
              variant="outlined"
              color="error"
              startIcon={<UnifiedIcon name="delete" />}
              onClick={onDelete}
              sx={{
                minWidth: 'auto',
                px: 1.5,
          ...
          <ListItemSecondaryAction>
            <Box sx={{ display: 'flex', gap: 0.5 }}>
              <Tooltip title="Upraviť">
                ...
                >
                  <UnifiedIcon name="edit" sx={{ fontSize: { sm: 18, md: 20 } }} />
                </IconButton>
              </Tooltip>
              <Tooltip title="Vymazať">
                <IconButton
                  ...
                  sx={{ color: 'error.main' }}
                >
                  <UnifiedIcon name="delete" sx={{ fontSize: { sm: 18, md: 20 } }} />
                </IconButton>
              </Tooltip>
            </Box>
          </ListItemSecondaryAction>
