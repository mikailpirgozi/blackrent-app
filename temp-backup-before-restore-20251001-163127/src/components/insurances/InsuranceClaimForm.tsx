      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <UnifiedIcon name="claim" sx={{ color: '#d32f2f' }} />
        ...
        <DialogContent dividers sx={{ p: 3 }}>
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent>
              ...
              >
                <UnifiedIcon name="event" sx={{ color: '#1976d2' }} />
                Základné informácie
              </Typography>
                    ...
                    >
                      ...
                      {vehicleInsurances.map(insurance => (
                        <MenuItem key={insurance.id} value={insurance.id}>
                          ...
                          >
                            <UnifiedIcon name="insurance" sx={{ fontSize: 16, color: '#1976d2' }} />
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent>
              <Typography
                ...
                sx={{ mb: 2, display: 'flex', alignItems: 'center', gap: 1 }}
              >
                <UnifiedIcon name="document" sx={{ color: '#f57c00' }} />
          ...
          <Card>
            <CardContent>
              <Typography
                ...
                sx={{ mb: 2, display: 'flex', alignItems: 'center', gap: 1 }}
              >
                <UnifiedIcon name="document" sx={{ color: '#7b1fa2' }} />
                Súbory a dokumenty
              </Typography>
