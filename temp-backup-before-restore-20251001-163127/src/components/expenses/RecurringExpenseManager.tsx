...
const RecurringExpenseManager: React.FC<RecurringExpenseManagerProps> = ({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="lg" fullWidth>
      ...
      >
        <UnifiedIcon name="repeat" sx={{ color: '#1976d2' }} />
      ...
      <DialogContent sx={{ p: 3 }}>
        ...
        >
          ...
          <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
            <Button
              variant="outlined"
              startIcon={<UnifiedIcon name="generate" />}
                      ...
                      <Box sx={{ mt: 1 }}>
                        ...
                        >
                          ...
                          <Grid item xs={12} sm={6} md={3}>
                            ...
                            >
                              <UnifiedIcon name="event" fontSize="small"
                                sx={{ color: 'text.secondary' }} />
                              <Typography
                                variant="body2"
                                color="text.secondary"
                      ...
                      <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap' }}>
                        {recurring.isActive && (
                          <Tooltip title="Vygenerovať teraz">
                            ...
                            >
                              <UnifiedIcon name="generate" fontSize="small" />
                            </IconButton>
                          </Tooltip>
                        )}
