        ...
        <CardContent>
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <UnifiedIcon name="report" sx={{ color: '#1976d2', fontSize: 28 }} />
              <Typography
                variant="h4"
          ...
          >
            <CardContent>
              ...
              >
                ...
                <UnifiedIcon name="report" sx={{ fontSize: 40, opacity: 0.8 }} />
              </Box>
            </CardContent>
          </Card>
        </Grid>
          ...
          {filteredSettlements.length === 0 ? (
            <Card sx={{ boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
              <CardContent sx={{ textAlign: 'center', py: 4 }}>
                <UnifiedIcon name="report" sx={{ fontSize: 48, color: 'text.secondary', mb: 2 }} />
                  ...
                  <CardContent sx={{ p: 2 }}>
                    ...
                    <Grid container spacing={1} sx={{ fontSize: '0.875rem' }}>
                      <Grid item xs={6}>
                        ...
                        >
                          <UnifiedIcon name="bank" fontSize="small"
