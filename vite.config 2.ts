...
export default defineConfig({
  ...
  server: {
    port: 3000,
    strictPort: true, // 🛡️ NIKDY nemieň port!
    open: false, // Neotváraj automaticky browser
    host: true,
    // Cache nastavenia pre stabilitu
    hmr: {
      overlay: false, // Vypne error overlay ktorý môže spôsobiť problémy
      port: 24678, // Špecifický HMR port
    },
    // Force reload pri zmenách v kritických súboroch
    watch: {
      usePolling: true,
      interval: 1000,
      ignored: ['**/node_modules/**', '**/dist/**'], // Ignoruj veľké priečinky
    },
  },
