...
with_node \
  ...
  --target "/Users/mikailpirgozi/Desktop/Cursor zalohy mac16/Blackrent Beta 2/apps/mobile/ios/Pods/Target Support Files/Pods-BlackRent/ExpoModulesProvider.swift" \
  --entitlement "/Users/mikailpirgozi/Desktop/Cursor zalohy mac16/Blackrent Beta 2/apps/mobile/ios/BlackRent/BlackRent.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-device" "expo-document-picker" "expo-file-system" "expo-font" "expo-haptics" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-local-authentication" "expo-localization" "expo-location" "expo-notifications" "expo-router" "expo-secure-store" "expo-web-browser"
