...
export interface UnifiedTypographyProps extends React.HTMLAttributes<HTMLElement> {
...
export const UnifiedTypography = forwardRef<HTMLElement, UnifiedTypographyProps>(
  ({
    variant = 'body1',
    color = 'textPrimary',
    align = 'inherit',
    ...
    const convertSxToClassName = (sx: Record<string, unknown>): string => {
      ...
      if (sx.fontWeight) {
        ...
        else if (weight === 'semibold' || weight === 600) classes.push('font-semibold');
        else if (weight === 'medium' || weight === 500) classes.push('font-medium');
        else if (weight === 'normal' || weight === 400) classes.push('font-normal');
        else if (weight === 'light' || weight === 300) classes.push('font-light');
      }
...
export const H1 = forwardRef<HTMLHeadingElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="h1" {...props} />
);
H1.displayName = 'H1';

export const H2 = forwardRef<HTMLHeadingElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="h2" {...props} />
);
H2.displayName = 'H2';

export const H3 = forwardRef<HTMLHeadingElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="h3" {...props} />
);
H3.displayName = 'H3';

export const H4 = forwardRef<HTMLHeadingElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="h4" {...props} />
);
H4.displayName = 'H4';

export const H5 = forwardRef<HTMLHeadingElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="h5" {...props} />
);
H5.displayName = 'H5';

export const H6 = forwardRef<HTMLHeadingElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="h6" {...props} />
);
H6.displayName = 'H6';

export const Subtitle1 = forwardRef<HTMLElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="subtitle1" {...props} />
);
Subtitle1.displayName = 'Subtitle1';

export const Subtitle2 = forwardRef<HTMLElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="subtitle2" {...props} />
);
Subtitle2.displayName = 'Subtitle2';

export const Body1 = forwardRef<HTMLElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="body1" {...props} />
);
Body1.displayName = 'Body1';

export const Body2 = forwardRef<HTMLElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="body2" {...props} />
);
Body2.displayName = 'Body2';

export const Caption = forwardRef<HTMLElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="caption" {...props} />
);
Caption.displayName = 'Caption';

export const Overline = forwardRef<HTMLElement, Omit<UnifiedTypographyProps, 'variant'>>(
  (props, ref) => <UnifiedTypography ref={ref} variant="overline" {...props} />
);
