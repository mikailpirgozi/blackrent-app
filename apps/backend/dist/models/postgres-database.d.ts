...
export declare class PostgresDatabase {
    ...
    constructor();
    private executeWithEnhancedRetry;
    ...
    getRecurringExpenseById(id: string): Promise<RecurringExpense | null>;
    ...
    updateSettlement(id: string, updateData: {
        totalIncome?: number;
        totalExpenses?: number;
        commission?: number;
        profit?: number;
    ...
    createReturnProtocol(protocolData: Partial<ReturnProtocol> & {
        id: string;
        rentalId: string;
    ...
    updateReturnProtocol(id: string, updateData: Partial<ReturnProtocol>): Promise<ReturnProtocol>;
    ...
    close(): Promise<void>;
    updateHandoverProtocol(id: string, updateData: Partial<HandoverProtocol>): Promise<HandoverProtocol>;
    getVehicleUnavailabilities(vehicleId?: string, startDate?: Date, endDate?: Date): Promise<VehicleUnavailability[]>;
    getVehicleUnavailability(id: string): Promise<VehicleUnavailability | null>;
    ...
    getCalendarDataUnified(startDate: Date, endDate: Date): Promise<Record<string, unknown>>;
    getUnavailabilitiesForDateRange(startDate: Date, endDate: Date): Promise<VehicleUnavailability[]>;
