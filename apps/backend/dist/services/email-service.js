...
class EmailService {
     ...
     */
    async sendReturnProtocolEmail(customer, pdfBuffer, protocolData) {
        if (!this.isEnabled || !this.transporter) {
            console.log('📧 EMAIL: Služba je vypnutá, email sa neodošle');
            return false;
        }
     ...
     */
    generateHandoverEmailTemplate(data) {
...
`;
     ...
     */
    generateReturnEmailTemplate(data) {
...
`;
     ...
     */
    generatePDFFilename(protocolType, data) {
     ...
     */
    async sendTestProtocolEmail(customer, pdfBuffer, protocolData) {
        if (!this.isEnabled || !this.transporter) {
            console.log('📧 EMAIL: Služba je vypnutá, email sa neodošle');
            return false;
        }
