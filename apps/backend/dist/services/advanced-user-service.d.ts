...
declare class AdvancedUserService {
    ...
    getOrganizationStats(organizationId: string): Promise<Record<string, unknown> | null>;
    ...
    getUserDetails(userId: string): Promise<Record<string, unknown> | null>;
    ...
    getActivityLog(organizationId: string, filters?: Record<string, unknown>, limit?: number): Promise<ActivityLog[]>;
    ...
    getTeamMembers(teamId: string): Promise<Record<string, unknown>[]>;
