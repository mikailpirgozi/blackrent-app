...
router.post('/', auth_1.authenticateToken, (0, permissions_1.checkPermission)('expenses', 'create'), (0, cache_middleware_1.invalidateCache)('expense'), async (req, res) => {
    try {
...
router.put('/:id', auth_1.authenticateToken, (0, permissions_1.checkPermission)('expenses', 'update', { getContext: getExpenseContext }), (0, cache_middleware_1.invalidateCache)('expense'), async (req, res) => {
    try {
        const { id } = req.params;
        const { description, amount, date, vehicleId, company, category, note } = req.body;
        // Povinné je len description
...
router.delete('/:id', auth_1.authenticateToken, (0, permissions_1.checkPermission)('expenses', 'delete', { getContext: getExpenseContext }), (0, cache_middleware_1.invalidateCache)('expense'), async (req, res) => {
    try {
        const { id } = req.params;
