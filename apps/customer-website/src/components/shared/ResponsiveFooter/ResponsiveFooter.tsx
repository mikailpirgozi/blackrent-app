        ...
        {screenWidth >= 1728 && (
          <div className="flex flex-col w-full items-center gap-2 pt-[200px] pb-0 px-0 bg-[#05050a]">
            ...
            <div className="flex flex-col items-center gap-[120px] relative">
              <div className="relative w-[300px] h-6 font-sf-pro font-[650] text-[40px] leading-[0.6em] text-center text-[#F0FF98]">
                Časté otázky
              </div>
            ...
            <div className="flex flex-col w-full items-center pt-24 pb-[72px] px-0 relative mt-20 bg-[#F0F0F5] rounded-3xl">
              ...
              <div className="inline-flex flex-col items-center gap-10 relative flex-[0_0_auto]">
                <header className="inline-flex flex-col items-start gap-4 relative flex-[0_0_auto]">
                  <h1 className="relative w-[874px] h-6 mt-[-1.00px] font-sf-pro font-normal text-[#283002] text-[32px] text-center tracking-[0] leading-6 whitespace-nowrap">
            ...
            <div className="flex flex-col w-full items-center pt-16 pb-16 px-8 bg-[#F0F0F5] rounded-2xl mx-auto">
              ...
              <div className="flex flex-col items-center gap-6">
                <div className="flex flex-col items-center gap-2">
                  <h3 className="font-sf-pro font-normal text-[#283002] text-2xl text-center tracking-[0] leading-8">
                    Potrebujete poradiť? Sme tu pre vás.
                  </h3>
          ...
          <div className="flex flex-col w-full items-center bg-[#05050a]">
            ...
            <div className="flex flex-col w-[680px] items-center gap-6 p-6 bg-[#F0F0F5] rounded-2xl mx-auto">
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="flex flex-col items-center gap-2">
                  <h3 className="font-sf-pro font-normal text-[#283002] text-xl text-center tracking-[0] leading-7">
                    Potrebujete poradiť? Sme tu pre vás.
                  </h3>
                  <p className="font-sf-pro font-medium text-[#A0A0A5] text-base text-center tracking-[0] leading-6">
                    Sme na príjme Po–Pia 08:00–17:00
        ...
        {screenWidth < 744 && (
          <div className="flex flex-col w-full items-center bg-[#05050a]">
            ...
            <div className="flex flex-col w-[328px] items-center gap-6 p-6 bg-[#F0F0F5] rounded-2xl mx-auto">
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="flex flex-col items-center gap-2">
                  <h3 className="font-sf-pro font-normal text-[#283002] text-lg text-center tracking-[0] leading-6">
                    Potrebujete poradiť? Sme tu pre vás.
                  </h3>
