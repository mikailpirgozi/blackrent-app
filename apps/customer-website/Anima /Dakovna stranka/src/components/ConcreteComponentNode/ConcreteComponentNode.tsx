...
export const ConcreteComponentNode = ({ property1 }: Props): JSX.Element => {
  return (
    <div className="flex w-[744px] h-20 items-center justify-center gap-2 px-4 py-2 relative bg-black">
      <p className="relative flex-1 [font-family:'Poppins',Helvetica] font-normal text-colors-black-1000 text-[10px] text-center tracking-[0] leading-[14px]">
        © 2024 blackrent.sk | Obchodné podmienky <br />| Pravidlá pre súbory
