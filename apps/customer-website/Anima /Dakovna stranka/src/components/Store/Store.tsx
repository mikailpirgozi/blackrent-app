...
export const Store = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative w-fit [font-family:'Poppins',Helvetica] font-medium text-colors-ligh-gray-800 text-sm text-right tracking-[0] leading-6 whitespace-nowrap ${divClassName}`}
      >
        SK
      </div>
    </div>
