...
import { Icon24Px34 } from "../../icons/Icon24Px34";
...
export const FooterWrapper = ({ className }: Props): JSX.Element => {
  return (
    <div
    ...
    >
      <div className="relative w-[1528px] h-[1068px] left-[200px]">
        ...
        <div className="inline-flex flex-col items-start gap-20 absolute top-[336px] left-0">
          <div className="relative w-[214.4px] h-8 bg-[url(/img/vector-19.svg)] bg-[100%_100%]" />
              ...
              <div className="flex flex-col w-[195px] items-start gap-8 relative">
                ...
                <div className="inline-flex items-start gap-4 relative flex-[0_0_auto]">
                  ...
                  <TypInstagram
                    ...
                    color="#A0A0A5"
                  />
                  <Icon24Px34 className="!relative !w-6 !h-6" color="#A0A0A5" />
                </div>
              </div>
            </div>
          </div>
