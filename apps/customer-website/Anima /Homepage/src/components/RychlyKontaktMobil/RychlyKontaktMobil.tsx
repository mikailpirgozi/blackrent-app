...
export const RychlyKontaktMobil = ({
  ...
  return (
    ...
    >
      <div className="absolute w-[104px] h-[104px] -top-12 left-28 rounded-[99px] border border-solid border-colors-white-800 bg-[url(/img/fotka-oper-tora-7.png)] bg-cover bg-[50%_50%]" />
